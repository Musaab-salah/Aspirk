...
export default function SummaryPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {/* Step Navigation */}
      <StepNavigation currentStep="summary" steps={steps} />
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-white rounded-lg shadow-md p-6">
              ...
              <div className="flex items-center p-3 bg-gray-50 rounded-lg">
                ...
                <div className="flex-1">
                  <p className="font-medium text-gray-900 font-arabic">
                    طريقة الدفع: {orderData.paymentMethod.nameAr}
                  </p>
                  <p className="text-sm text-gray-600 font-arabic">
                    {orderData.paymentMethod.descriptionAr}
                  </p>
                  {orderData.paymentMethod.accountNumber && (
                    <p className="text-sm text-gray-500 font-arabic">
                      رقم الحساب: {orderData.paymentMethod.accountNumber}
                    </p>
                  )}
                </div>
              </div>
